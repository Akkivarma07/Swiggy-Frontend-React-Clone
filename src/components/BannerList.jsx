...
//         //         <div ref={sliderRef} className='keen-slider'>
// //           {banners.card.card.gridElements.infoWithStyle.info.map((banner) => (
// //             // Add a check for each property you're trying to access
// //             banner && banner.id ? (
// //               <Banner banner={banner} key={banner.id} />
// //             ) : null
// //           ))}
...
const BannerList = ({ isLoading, banners }) => {
  ...
  if (
    ...
    !banners.card ||
    !banners.card.card ||
    !banners.card.card.gridElements ||
    !banners.card.card.gridElements.infoWithStyle ||
    !banners.card.card.gridElements.infoWithStyle.info
  ) {
    // Add additional checks for nested properties to avoid errors
    return null;
  }
