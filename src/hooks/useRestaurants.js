...
const useRestaurants = () => {
  ...
  const getRestaurants = async () => {
    ...
    try {
      console.log(address);
      setIsLoading(true);
      const { data } = await axios.get("https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.5623169&lng=77.2803832&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
      , address);
